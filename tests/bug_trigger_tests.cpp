...
TEST(BugTrigger_Critical, Bug_1_IteratorArithmeticOverflow)
{
    ...
    std::string malformedSIP = "INVITE sip:user@example.com SIP/2.0\r\n"
...
{
    std::string buffer = "INVITE sip:user@example.com SIP/2.0\r\n"
                         "Via: SIP/2.0/UDP pc33.example.com;branch=z9hG4bK776asdhds\r\n"
                         "Max-Forwards: 70\r\n"
                         "To: <sip:user@example.com>\r\n"
                         "From: Alice <sip:alice@example.com>;tag=1928301774\r\n"
    ...
    try
    {
        auto _ = sip2json::parseAsync(buffer,
                                      [&](sipmessage&& msg)
                                      {
                                          parseCount++;
...
{
    std::string sdpWithBadTiming = "INVITE sip:user@example.com SIP/2.0\r\n"
                                   "Via: SIP/2.0/UDP pc33.example.com;branch=z9hG4bK776asdhds\r\n"
                                   "Max-Forwards: 70\r\n"
                                   "To: <sip:user@example.com>\r\n"
                                   "From: Alice <sip:alice@example.com>;tag=1928301774\r\n"
...
TEST(BugTrigger_Medium, Bug_9_UnsafeStringComparison)
{
    ...
    try
    {
        ...
        if (result["h"].contains("Authorization")) { std::cout << "Bug #9: Authorization header found" << std::endl; }
...
{
    std::string sdpWithEdgeAttributes = "INVITE sip:user@example.com SIP/2.0\r\n"
                                        "Via: SIP/2.0/UDP pc33.example.com;branch=z9hG4bK776asdhds\r\n"
                                        "Max-Forwards: 70\r\n"
                                        "To: <sip:user@example.com>\r\n"
                                        "From: Alice <sip:alice@example.com>;tag=1928301774\r\n"
...
{
    std::string buffer = "INVALID_START_LINE\r\n"
    ...
    try
    {
        auto _ = sip2json::parseAsync(buffer2, [&](sipmessage&& msg) { parseCount++; });
...
{
    std::string sdpWithSpecialChars = "INVITE sip:user@example.com SIP/2.0\r\n"
                                      "Via: SIP/2.0/UDP pc33.example.com;branch=z9hG4bK776asdhds\r\n"
                                      "Max-Forwards: 70\r\n"
                                      "To: <sip:user@example.com>\r\n"
                                      "From: Alice <sip:alice@example.com>;tag=1928301774\r\n"
...
{
    std::string largeContentLength = "INVITE sip:user@example.com SIP/2.0\r\n"
                                     "Via: SIP/2.0/UDP pc33.example.com;branch=z9hG4bK776asdhds\r\n"
                                     "Max-Forwards: 70\r\n"
                                     "To: <sip:user@example.com>\r\n"
                                     "From: Alice <sip:alice@example.com>;tag=1928301774\r\n"
    ...
    {
        auto result = sip2json::parseFromBuffer(bufferStart, bufferEnd);
        std::cout << "Bug #18: Parsed message with large Content-Length: " << result.getContentLength() << std::endl;
    }
    catch (const std::exception& e)
    {
...
{
    std::string complexMessage = "INVITE sip:user@example.com SIP/2.0\r\n"
                                 "Via: SIP/2.0/UDP pc33.example.com;branch=z9hG4bK776asdhds\r\n"
                                 "Max-Forwards: 70\r\n"
                                 "To: <sip:user@example.com>\r\n"
                                 "From: Alice <sip:alice@example.com>;tag=1928301774\r\n"

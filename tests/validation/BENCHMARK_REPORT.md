...
- **Latency Reduction**: Average per-message latencies were reduced down to **30.01 us/msg** (`parse`), **30.07 us/msg** (`parseAsync`), and **25.46 us/msg** (`parseFromBuffer`).
...
| Avg Per-Msg Latency | 46.85 us | 50.92 us | 51.89 us | 30.55 us | **30.07 us** | **-16.78 us (-35.9%)** | **-21.82 us (-42.1%)** |
...
| Avg Per-Msg Latency | 40.37 us | 43.79 us | 45.17 us | **27.36 us** | **27.36 us** | **-13.01 us (-32.2%)** | **-17.81 us (-39.4%)** |

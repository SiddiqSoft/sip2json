...
!!! tip "Windows Setup Note"
    Run [`scripts/prep_windows_machine.ps1`](https://github.com/SiddiqSoft/sip2json/blob/master/scripts/prep_windows_machine.ps1) as Administrator to configure Windows Registry `LongPathsEnabled = 1` and Git `core.longpaths = true` for CTRE header resolution.

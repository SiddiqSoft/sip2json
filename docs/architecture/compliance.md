...
graph TD
    subgraph Core ["SIP Core Standards"]
        ...
        B["RFC 3261 Section 20: Compact Header Abbreviations"]
        C["RFC 3261 Section 7.3.1: Case-Insensitive Normalization"]
    end
...
### 1. SIP Start Line Verification (RFC 3261 Section 7.1 & Section 7.2)
...
### 2. Header Field Processing (RFC 3261 Section 7.3.1 & Section 20)
